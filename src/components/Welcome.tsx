...
const Welcome = () => {
  return (
    ...
    <div data-aos="fade-right" className=" flex flex-col max-w-[350px] sm:max-w-[450px] gap-6">
    ...
    <div data-aos="fade-left" className="p-3 max-w-[350px] sm:max-w-[450px] md:max-w-[400px] lg:max-w-[450px] w-full flex flex-col justify-between h-[200px] sm:h-[280px] relative drop-shadow-md bg-gradient-to-tr from-pink-500 via-violet-400 to-indigo-500 rounded-lg">
