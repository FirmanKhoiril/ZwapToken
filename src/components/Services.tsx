...
const Services = () => {
  return (
    <section className="w-full h-full sm:flex-row flex-col pb-10 relative gap-10 min-h-[30dvh] flex items-center  justify-around">
      ...
      <div className="w-full max-w-[680px]" data-aos="fade-right">
        <h1 className="text-[32px] pb-2 sm:text-[56px]">
        Services that we
          <br />
          continue to improve
        </h1>
